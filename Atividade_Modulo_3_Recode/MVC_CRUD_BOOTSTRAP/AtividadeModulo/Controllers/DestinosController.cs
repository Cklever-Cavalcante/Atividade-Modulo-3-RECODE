...
namespace AtividadeModulo.Controllers
{
    public class DestinosController : Controller
    {
        ...
        public DestinosController(AgenciaViagensRecodeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdDestino,Cidade,Estado,Pais")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDestino,Cidade,Estado,Pais")] Destino destino)
        {
