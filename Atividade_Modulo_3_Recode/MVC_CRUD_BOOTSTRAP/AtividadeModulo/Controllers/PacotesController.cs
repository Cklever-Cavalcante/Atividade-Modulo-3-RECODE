...
namespace AtividadeModulo.Controllers
{
    ...
    {
        private readonly AgenciaViagensRecodeContext _context;

        public PacotesController(AgenciaViagensRecodeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPacote,NumAcompanhantes,HospedagemSimNao,Preco,DataIda,DataVolta")] Pacote pacote)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPacote,NumAcompanhantes,HospedagemSimNao,Preco,DataIda,DataVolta")] Pacote pacote)
        {
